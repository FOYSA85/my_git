...
# cursor.execute("CREATE TABLE IF NOT EXISTS category_list (category text NOT NULL)")
# cursor.execute("CREATE TABLE IF NOT EXISTS Complete_Tasks (Tasks text NOT NULL, date_time text, day_month_int integer)")
# cursor.execute("CREATE TABLE IF NOT EXISTS Default_ (Tasks text NOT NULL, date_time text, day_month_int integer)")
# conn.commit()
...
# Implement icons
menu_image = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_162101.png")
task_image = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_161457.png")
back_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_070720.png")
search_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_161827.png")
notification_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_161921.png")
circle_image = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240824_200153.png")
cloud_image = Image.open("C:/Users/MD Foysal/Downloads/1.png")
template_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_203218.png")
category_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/6488533.png")
analytics_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_203056.png")
create_category_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240822_204529.png")
project_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/project_icon.png")
delete_icon = Image.open("C:/Users/MD Foysal/Downloads/trash-2-64.png")
edit_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/edit_best_icon.png")
calculator_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/Calculator_512.webp")
calender_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/calender icon.webp")
clock_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/clock_icon.png")
age_calculator_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/age_calculator.png")
progress_icon1 = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240824_195738.png")
progress_icon2 = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240824_195840.png")
progress_icon3 = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240824_195937.png")
progress_icon4 = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240824_200002.png")
calendar_logo = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240915_194315.png")
microphone_logo = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/20240915_205641.png")



ctk_menu_image = CTkImage(menu_image, size=(30, 20))
ctk_back_icon = CTkImage(back_icon, size=(25, 25))
ctk_task_image = CTkImage(task_image, size=(150, 150))
ctk_search_icon = CTkImage(search_icon, size=(40, 40))
ctk_notification_icon = CTkImage(notification_icon, size=(20, 20))
ctk_circle_image = CTkImage(circle_image, size=(140, 140))
ctk_cloud_image = CTkImage(cloud_image, size=(200, 150))
...
ctk_progress_icon1 = CTkImage(progress_icon1, size=(140, 10))
ctk_progress_icon2 = CTkImage(progress_icon2, size=(140, 10))
ctk_progress_icon3 = CTkImage(progress_icon3, size=(140, 10))
ctk_progress_icon4 = CTkImage(progress_icon4, size=(140, 10))
...
def create_category_database(category) :
    ...
    if table_exists == None :
        cursor.execute(f"CREATE TABLE IF NOT EXISTS {category} (Tasks text NOT NULL, date_time text, day_month_int integer)")
...
# def on_frame_click():
# CTkFrame এ ক্লিক ইভেন্ট যোগ করুন
# category_frame2.bind("<Button-1>", lambda e: on_frame_click())
# category_frame1.bind("<Button-1>", lambda e: on_frame_click())
# record_count = 0
...
def add_task_widget():
    ...
    # # confermation button
    # okay_btn = CTkButton(calendar_frame, text='Ok', font=font)
    # okay_btn.grid(row=44, column=1)
    # CTkComboBox তৈরি করুন
    combo_box = CTkComboBox(
        ...
        font=('Arial', 20))
    # combo_box.set('Choice category for your task')
    ...
    # create_category_btn = CTkButton(
    #     add_task_frame, 
    #     image=ctk_create_category_icon, 
    #     text='', 
    #     width=10, 
    #     fg_color='transparent'
    #     )
...
def add_task_in_frame(category, date, click_day, click_month) :
    ...
    if task != '' :
        ...
        cursor.execute(f'INSERT INTO {categ} (Tasks, date_time, day_month_int) VALUES (?, ?, ?)', (task, date, clicked_date))
        conn.commit()
        if categ == c :
...
def delete_tasks(tasks, date, frame, checkbox, clicked_date) :
    ...
    cursor.execute("INSERT INTO Complete_Tasks (Tasks, date_time, day_month_int) VALUES (?, ?, ?)", (tasks, date, clicked_date))
    cursor.execute(f"DELETE FROM {c} WHERE Tasks=?", (tasks,))
    conn.commit()
    # tsk_count.configure(text= str(count_tasks("Complete_Task")+1) + ' Tasks')

# Add button implementation
add_icon = Image.open("C:/Users/MD Foysal/OneDrive/Pictures/add icon.png")
ctk_add_icon = CTkImage(add_icon, 
                        size=(40, 40))
