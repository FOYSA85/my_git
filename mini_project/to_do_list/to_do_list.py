...
animated_circle = Image.open("C:/Users/MD Foysal/OneDrive/Desktop/to_do_list_icon/animated_circle.jpeg")
...
ctk_animated_circle = CTkImage(animated_circle, size=(120, 110))
...
def open_menu_frame():
    ...
    animated_circle_lbl = CTkLabel(
        menu_frame,
        image=ctk_animated_circle,
        text=''
    )
    ...
    animated_circle_lbl.place(x=250, y=600)
